...
<div class="app-title">
  <div>
    <h1><i class="fa fa-table"></i> Edit Table</h1>
  ...
  <ul class="app-breadcrumb breadcrumb">
    ...
    <li class="breadcrumb-item">Edit Table</li>
  </ul>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
        <form method="POST" action="{{ route('bar.tables.update', $table) }}">
          @csrf
          @method('PUT')
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="alert alert-info">
                <i class="fa fa-info-circle"></i> <strong>Capacity Management:</strong> Table capacity is automatically calculated based on active orders. Currently: <strong>{{ $table->current_people }} people</strong> seated, <strong>{{ $table->remaining_capacity }} seats</strong> remaining.
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea class="form-control @error('notes') is-invalid @enderror" 
                          name="notes" 
                          rows="3" 
                          placeholder="Any additional notes about this table">{{ old('notes', $table->notes) }}</textarea>
                @error('notes')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
          ...
          <div class="tile-footer">
            <button class="btn btn-primary" type="submit">
              <i class="fa fa-fw fa-lg fa-check-circle"></i>Update Table
            </button>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (statusSelect) {
      // Prevent selecting "occupied" manually
      statusSelect.addEventListener('change', function() {
        if (this.value === 'occupied') {
          // If user tries to select occupied, revert to available
          this.value = 'available';
          alert('Status "Occupied" is automatically managed by the system. Please select Available, Reserved, or Out of Service.');
        }
      });
    }
  });
