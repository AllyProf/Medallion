...
@section('title', 'Drinks Orders')

@section('content')
<div class="app-title">
  <div>
    <h1><i class="fa fa-glass"></i> Drinks Orders</h1>
    <p>Bar station - Manage drink orders</p>
  </div>
  <ul class="app-breadcrumb breadcrumb">
    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('bar.orders.index') }}">Orders</a></li>
    <li class="breadcrumb-item">Drinks Orders</li>
  </ul>
</div>
  ...
  <div class="col-md-12">
    <div class="tile">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="tile-title">Drinks Orders - Bar Station</h3>
        <div>
      ...
      <div class="tile-body" id="drinksOrdersContainer">
        @if($orders->count() > 0)
          <div class="row">
              ...
              <div class="col-md-6 col-lg-4 mb-4 order-card" data-order-id="{{ $order->id }}">
                <div class="card shadow-sm border-0 h-100">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      <h6 class="text-info"><i class="fa fa-glass"></i> YOUR DRINK ITEMS:</h6>
                      <ul class="list-unstyled mb-0">
                        @foreach($order->drink_items as $item)
        ...
        @else
          <div class="alert alert-info">
            <i class="fa fa-info-circle"></i> No drinks orders found.
          </div>
        @endif
      </div>
    </div>
  ...
  $(document).ready(function() {
    ...
    @if(config('broadcasting.default') === 'pusher' && config('broadcasting.connections.pusher.key'))
      ...
      channel.bind('order.updated', function(data) {
        if (data.order && (!data.order.notes || (!data.order.notes.includes('FOOD ITEMS:') && !data.order.notes.includes('JUICE ITEMS:')))) {
          location.reload();
        }
      });
    ...
    @else
      ...
      setInterval(function() {
        ...
        $.get('{{ route('bar.orders.drinks') }}', function(data) {
