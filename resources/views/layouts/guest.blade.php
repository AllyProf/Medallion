...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Medallion Restaurant')</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="{{ asset('restoran/img/favicon.ico') }}" rel="icon">
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>{{ $owner->business_name ?? 'Medallion' }}</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        <a href="{{ route('public.restaurant.menu', $owner->id) }}" class="nav-item nav-link {{ request()->routeIs('public.restaurant.menu') ? 'active' : '' }}">Menu</a>
                        <a href="{{ route('public.restaurant.feedback', $owner->id) }}" class="nav-item nav-link {{ request()->routeIs('public.restaurant.feedback') ? 'active' : '' }}">Feedback</a>
                    </div>
                </div>
            </nav>
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">@yield('header_title')</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">@yield('breadcrumb')</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        {{-- Footer removed to avoid duplication with custom menu footer --}}
