      ...
      <div class="tile-body">
        <form method="POST" action="{{ route('admin.plans.update', $plan) }}">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control @error('trial_days') is-invalid @enderror" id="trial_days" name="trial_days" value="{{ old('trial_days', $plan->trial_days) }}" min="0" required>
                @error('trial_days')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control @error('max_locations') is-invalid @enderror" id="max_locations" name="max_locations" value="{{ old('max_locations', $plan->max_locations) }}" min="1" required>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="features_text" rows="5" placeholder="Enter features, one per line">{{ old('features_text', is_array($plan->features) ? implode("\n", $plan->features) : '') }}</textarea>
